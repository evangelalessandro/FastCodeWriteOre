    ...
    public partial class frmMain : Form
    {
        ...
        private void SelectFile()
        {
            ...
            using (OpenFileDialog res = new OpenFileDialog())
            {
                ...
                var dirTemp = SpecialDirectories.Temp;
                var tempFile = new FileInfo(Assembly.GetExecutingAssembly().Location).DirectoryName + "\\template\\Prototipo.xlsx";
                var destFile = dirTemp + "\\Prototipo.xlsx";
                System.IO.File.Copy(tempFile, destFile, true);

                _impostazioni.RaccoltaDati.File = destFile;
